...
@section('content')
<div class="my-5">
    <a href="{{url("admin/users")}}" class="bg-indigo-400 hover:bg-indigo-500 relative shadow-xl rounded-md p-2 mb-12 lg:mb-3 text-gray-100">
        Back to Users
    </a>
</div>

<div class="bg-gray-100">
 <div class="w-full text-white bg-indigo-400 hover:bg-indigo-500">
        <div
        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-indigo-400">
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{($user->last_name)}} {{($user->first_name)}}</h1>
                    ...
                    <div class="text-gray-700">
                        <div class="grid md:grid-cols-2 text-sm">
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">{{\Gender::getValue($user->gender)}}</div>
                            </div>
                            <div class="grid grid-cols-2">
