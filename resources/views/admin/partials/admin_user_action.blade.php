<a href="{{url('/admin/counsellor/edit/' . Hashids::encode($user->id))}}" class=" p-2 rounded-md bg-blue-600 text-white text-md">
    <span class="inline-flex"><i class="bx bxs-edit mr-1"></i></span>
    Edit
</a>

<form action="{{url('/admin/counsellor/delete/' . Hashids::encode($user->id))}}" class="inline-block" method="POST">
    @csrf
