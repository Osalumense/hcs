...
<section class="bg-gray-100  bg-opacity-50 h-screen">
    <div class="mx-auto container max-w-2xl md:w-3/4 shadow-md">
      ...
      <div class="bg-white space-y-6">
        ...
        <hr />
        <div class="w-full p-4 text-right text-gray-200">
          <button class="inline-flex items-center hover:bg-red-600 shadow-sm focus:outline-none bg-red-500 p-2 rounded-md mr-4">
            <svg
              fill="none"
              class="w-4 mr-2"
              viewBox="0 0 24 24"
